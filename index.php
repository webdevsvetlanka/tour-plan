        ...
        <div class="packages-card packages-card--big">
          ...
          <div class="packages-card__inform packages-card__inform--big">
            <div class="packages-card__info packages-card__info--big">
              ...
              <button class="button packages-card__btn packages-card__btn--big">Book Now</button>
            </div>
          </div>
        </div>
        ...
        <div class="packages-card">
          ...
          <div class="packages-card__inform">
            <div class="packages-card__info">
              ...
              <button class="button packages-card__btn">Book Now</button>
            </div>
          </div>
        </div>
  ...
  <section class="newsletter" data-type="background" data-speed="5">
    <div class="container">
      <div class="newsletter-wrapper">
        ...
        <form action="send.php" method="POST" class="search newsletter__search">
          <input name="email" type="text" class="newsletter__input" placeholder="Your email address    " />
          ...
          <div class="swiper-wrapper">
              ...
              <div class="reviews-slider reviews-slider__item">
                <div class="reviews-slider__profile">
                  <div class="reviews-slider__image">
                    <img src="./img/reviews/avatar-reviews-1.jpg" alt="Avatar: Megan Fox"
            ...
            <!-- <div class="swiper-slide">
              <div class="reviews-slider__item">
                <div class="reviews-slider__profile">
                  <div class="reviews-slider__image">
                    <img src="./img/avatar-reviews-2.jpg" alt="Avatar: Janice Burke" class="reviews-slider__avatar">
                  </div>
                  <h3 class="reviews-slider__username">Janice Burke</h3>
                  <span class="reviews-slider__date">Stayed 08 Mar, 2014</span>
                  <div class="rating">
                    <svg width="8" height="8">
                      <use xlink:href="img\icons.svg#star"></use>
                    </svg>
                ...
                <p class="reviews-slider__text">
                  The room is very family friendly. The room had a small kitchen with everything you need. The room has
                  been renovated. Breakfast at the hotel was not provided. The location is very convenient. All
